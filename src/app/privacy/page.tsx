          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-4">
                ...
                <p className="text-amber-700 text-sm">We never sell your personal information to third parties. All data sharing is strictly for service provision and regulatory compliance.</p>
              </div>
            </section>
