...
import { CheckCircle, Circle, Target, TrendingUp, Hand, Shield, AlertTriangle } from 'lucide-react'
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-warning/80">
              ...
              Automated stop loss rules will be added in the next version. Position sizing rules
              are managed in the Positions tab under the Rules section.
            </p>
          </div>
        </div>
      </div>
